        ...
        <div className='min-h-screen px-4 md:px-8 lg:px-[5rem] py-8 md:py-[2.5rem]'>
            <div className='flex flex-col md:flex-row gap-8 md:gap-12'>
                ...
                <div className='w-full h-auto md:w-[60%] lg:w-[65%] xl:w-full max-w-[600px] mx-auto md:mx-0 bg-transparent rounded-lg overflow-hidden'>
                    <img src={image} alt="Branded Backpack" className='w-[80%] mx-auto object-contain rounded-md shadow-md' />
                    
                    {/* Small Images Row */}
                    <div className='flex gap-2 p-4 justify-center'>
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className='w-16 h-16 border border-[#400E32] rounded-md cursor-pointer overflow-hidden'>
                                <img src={image} alt="" className='w-full h-full object-cover hover:opacity-80 transition-opacity' />
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className='w-full md:w-[40%] lg:w-[35%] flex flex-col gap-4 text-black'>
                    <h1 className='text-2xl md:text-3xl font-bold'>Branded Glowy Backpack</h1>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <span className='bg-[#F2CD5C] px-2 py-1 rounded-md text-sm font-bold'>Save 20%</span>
                    </div>
                    
                    <div className='flex items-center gap-1'>
                        {[1, 2, 3, 4,5].map((star) => (
                            <span key={star} className='text-[#F2CD5C] text-xl'>★</span>
                        ))}
                    ...
                    <div className='my-4'>
                        ...
                        <p className='text-black'>
                            Premium quality backpack perfect for everyday use. Made with water-resistant material, 
                            multiple compartments for organization, padded laptop sleeve, and comfortable shoulder straps.
                        </p>
                    </div>
