    ...
    return (
        <div className="bg-[#575b66] bg-opacity-80 p-8 rounded-lg w-full max-w-md mx-auto shadow-[0_10px_10px_rgba(0,0,0,0.25)]" >
            ...
            <form className="space-y-5">
                ...
                <div className={`transition-all duration-300 ${!isLogin ? 'opacity-100 max-h-24' : 'opacity-0 max-h-0 overflow-hidden'}`}>
                    <div className="relative">
                        ...
                        <label 
                            ...
                            className={`absolute left-3 transition-all duration-200 ${
                                focusedField === 'name' ? 'text-[#F2CD5C] text-xs top-2' : ' text-sm top-5'
                ...
                <div className="relative">
                    ...
                    <label 
                        htmlFor="email" 
                        className={`absolute left-3 transition-all duration-200 ${
                            focusedField === 'email' ? 'text-[#F2CD5C] text-xs top-2' : 'text-sm top-5'
                        } peer-focus:text-xs peer-focus:top-2 peer-focus:text-[#F2CD5C] peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:top-2`}
                    >
                        Email or phone
                    </label>
                ...
                <div className="relative">
                    ...
                    <label 
                        htmlFor="password" 
                        className={`absolute left-3 transition-all duration-200 ${
                            focusedField === 'password' ? 'text-[#F2CD5C] text-xs top-2' : 'text-sm top-5'
                        } peer-focus:text-xs peer-focus:top-2 peer-focus:text-[#F2CD5C] peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:top-2`}
                    >
                        Password
                    </label>
                ...
                <div className={`transition-all duration-300 ${!isLogin ? 'opacity-100 max-h-24' : 'opacity-0 max-h-0 overflow-hidden'}`}>
                    <div className="relative">
                        ...
                        <label 
                            htmlFor="phone" 
                            className={`absolute left-3 transition-all duration-200 ${
                                focusedField === 'phone' ? 'text-[#F2CD5C] text-xs top-2' : 'text-sm top-5'
                            } peer-focus:text-xs peer-focus:top-2 peer-focus:text-[#F2CD5C] peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:top-2`}
                        >
